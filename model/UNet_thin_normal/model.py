...
class CombNet(nn.Module):
    def __init__(self, in_channel_1=64, in_channel_2=128, thin_in_channel=1, thin_out_channel=128, num_class=14):
        super(CombNet, self).__init__()

        self.thin_UNet = BuildThinUNet(
                in_channel=thin_in_channel,
                out_channel=thin_out_channel
                )
        self.expand_2 = CreateUpConvBlock(thin_out_channel, in_channel_2, in_channel_2, in_channel_2)
